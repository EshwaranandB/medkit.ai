...
const offerings = [
  ...
  },
  {
    ...
    description: "Upload prescription photos and get instant explanations."
  },
  {
    icon: "🤖",
    title: "AI Health Assistant",
    description: "Get personalized health guidance and answers to your questions."
  }
];

export default function Stats() {
  return (
    <section className="py-20 bg-gradient-to-br from-black via-[#18192b] to-violet-950">
